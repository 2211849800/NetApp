...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl border border-purple-100 p-6 shadow-sm">
        <h2 class="font-semibold text-gray-800 mb-2">Admin Dashboard</h2>
        <p class="text-sm text-gray-500">Placeholder — full admin features will be implemented in upcoming phases.</p>
    </div>
</div>
@endsection
